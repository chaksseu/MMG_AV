...
, help="Video 모델 체크포인트 경로")
    ...
    datasets = ["vggsound_sparse"]
    model_type = "FULL" # "LORA" "FULL"

    video_lora_ckpt_path_list = ["checkpoint-step-253952"]

    for dataset in datasets:
        video_lora_ckpt = f"/home/work/kby_hgh/VIDEO_{model_type}_CHECKPOINT_0627/1e-5"
        # save_dir = f"/home/work/kby_hgh/0603_video_teacher_{model_type}_{dataset}_inference"
        save_dir = f"/home/work/kby_hgh/0716_teacher_full_vggsound_sparse/video"
        ...
        if dataset == "openvid":
            args.prompt_file = "/home/work/kby_hgh/MMG_01/video_lora_training/0602_processed_Openvid_test_with_audio_caption.csv"
