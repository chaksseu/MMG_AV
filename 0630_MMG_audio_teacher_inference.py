...
def main():
    ...
    parser.add_argument("--bs", type=int, default=32, help="배치 사이즈")
    ...
    for ckpt_num in ckpt_number:
        args.audio_lora_ckpt_path = f"/home/work/kby_hgh/AUDIO_FULL_CHECKPOINT_0709/1e-6/checkpoint-step-{ckpt_num}/model.safetensors"
        # args.savedir = f"/home/work/kby_hgh/0716_teacher_full_vggsound_sparse/{ckpt_num}"
        args.savedir = f"/home/work/kby_hgh/0716_teacher_full_vggsound_sparse/audio"
