...
def save_videos(batch_tensors, savedir, base_filename, fps=10):
    for idx, vid_tensor in enumerate(batch_tensors):
        ...
        # ImageSequenceClip을 사용하여 비디오 클립 생성
...
def get_parser():
    ...
    parser.add_argument("--savedir", type=str, default="1217_mmg_cross_linear_test", help="Output directory")
    ...
    parser.add_argument("--cross_modal_checkpoint_path", type=str, default="mmg_checkpoints/1216_new_linear_lr_1e-05_batch_1024_global_step_34000_vggsound_sparse/model.safetensors", help="Cross-modal checkpoint path")
    ...
    parser.add_argument("--device_id", type=int, default=7, help="GPU device ID")
    return parser
...
def run_inference(args, device, dtype):
    ...
    for batch_idx in range(num_batches):
        ...
        for i in range(current_batch_size):
            ...
            # 비디오 프레임 저장
            single_video_frames = video_frames[i].unsqueeze(0)  # 배치 차원 추가
            save_videos(single_video_frames, video_dir, base_filename, fps=args.savefps)
