...
def main():
    ...
    dataset_list = ["vgg", "ac"]
    checkpoint_dir_list = ["22175", "24191", "26207", "28223", "30239", "32255", "34271", "36287", "38303", "40319", "42335", "44351", "46367", "48383", "50399", "52415", "54431", "56447", "58463", "60479", "62495", "64511", "66527", "68543", "70559", "72575", "74591"]
    ...
    for checkpoint_dir in checkpoint_dir_list:
        for dataset in dataset_list:
            ...
            # vbench
            if dataset == "vbench":
                args.prompt_file = "/home/work/kby_hgh/vbench_all_captions_with_audio_caption.csv" # "/home/work/kby_hgh/vbench_all_captions.csv"
            if dataset == "ac":
                args.prompt_file = "/home/work/kby_hgh/MMG_AC_test_dataset/0407_one_cap_AC_test_with_video_caption.csv" # "/home/work/kby_hgh/MMG_AC_test_dataset/0407_one_cap_AC_test.csv"
            ...
            ckpt_dir = f"/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0524_FINAL_FILTERED_MMG_RC_LENEAR_T_1e5_1e-5_ta_tv_weight_1_2_1e5_/checkpoint-step-{checkpoint_dir}"
            eval_id = f"MMG_FINAL_FILTERED_RC_DISTILL_LINEAR_T_1e5_{dataset}_step_{checkpoint_dir}"
