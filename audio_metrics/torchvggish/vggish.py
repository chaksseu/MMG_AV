...
class VGGish(VGG):
    def __init__(self, urls, device=None, pretrained=True, preprocess=True, postprocess=True, progress=True):
        ...
        if pretrained:
            ...
            state_dict = torch.load("/home/work/kby_hgh/torch_hub/checkpoint/vggish-10086976.pth", weights_only=False)
        ...
        if self.postprocess:
            ...
            if pretrained:
                state_dict = torch.load("/home/work/kby_hgh/torch_hub/checkpoint/vggish_pca_params-970ea276.pth", weights_only=False)
