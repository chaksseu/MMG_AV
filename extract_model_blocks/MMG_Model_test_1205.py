...
def mm_forward(audio_unet, audio_latents, audio_timestep, audio_encoder_hidden_states,
    ...
    #cross_video_latent = rearrange(h, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()

    h = video_cmt[0](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[0](cross_audio_latent, h)
    ...
    cross_audio_latent = rearrange(audio_hidden_states, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()
    h = video_cmt[1](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[1](cross_audio_latent, h)
    audio_hidden_states = rearrange(cross_audio_latent, '(b tv) c f t -> b c f (t tv)', b=b, tv=video_fps).contiguous()
    ...
    cross_audio_latent = rearrange(audio_hidden_states, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()
    h = video_cmt[2](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[2](cross_audio_latent, h)
    audio_hidden_states = rearrange(cross_audio_latent, '(b tv) c f t -> b c f (t tv)', b=b, tv=video_fps).contiguous()
    ...
    cross_audio_latent = rearrange(audio_hidden_states, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()
    h = video_cmt[3](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[3](cross_audio_latent, h)
    audio_hidden_states = rearrange(cross_audio_latent, '(b tv) c f t -> b c f (t tv)', b=b, tv=video_fps).contiguous()
    ...
    cross_audio_latent = rearrange(audio_hidden_states, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()
    h = video_cmt[4](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[4](cross_audio_latent, h)
    audio_hidden_states = rearrange(cross_audio_latent, '(b tv) c f t -> b c f (t tv)', b=b, tv=video_fps).contiguous()
    ...
    cross_audio_latent = rearrange(audio_hidden_states, 'b c f (t tv) -> (b tv) c f t', tv=video_fps).contiguous()
    h = video_cmt[5](h, cross_audio_latent)
    cross_audio_latent = audio_cmt[5](cross_audio_latent, h)
    audio_hidden_states = rearrange(cross_audio_latent, '(b tv) c f t -> b c f (t tv)', b=b, tv=video_fps).contiguous()
...
def main():
    ...
    # Generate input data
    video_fps = 40
    video_latents = torch.randn(batch_size, 4, video_fps, 64, 64)  # (B, C, T, H, W)
