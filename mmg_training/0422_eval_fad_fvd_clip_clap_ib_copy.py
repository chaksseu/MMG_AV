...
def main():
    ...
    parser.add_argument("--device", type=int, default=6, help="CUDA 디바이스 번호")
...
\
    ...
    modality ="all"
    model_name_list = [0]
    checkpoint_dir_list = [0] # step_20351, step_10175
    ...
    for model_name in model_name_list:
        for checkpoint_num in checkpoint_dir_list:
            ...
            inference_save_path = f"/home/work/kby_hgh/MMG_Inferencce_folder/tensorboard/0419_MMG_OURS_1e-4_8gpu_videocaption_step_10143_vggsound_sparse"

            results = evaluate_model(args, device, target_path, inference_save_path, modality)

            result_csv_path = f"MMG_OURS_{modality}_eval_results.csv"
