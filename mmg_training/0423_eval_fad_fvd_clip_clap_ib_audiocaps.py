...
def main():
    ...
    # checkpoint_dir_list = ["12095", "14111", "16127", "18143", "20159", "22175", "24191", "26207", "28223", "30239", "32255", "34271", "36287", "38303", "40319", "42335", "44351", "46367", "48383", "50399", "52415", "54431", "56447", "58463", "60479"]


    checkpoint_dir_list = ["8760", "10220", "11680", "13140", "14600"]
    ...
    for model_name in model_name_list:
        for checkpoint_num in checkpoint_dir_list:
            if dataset == "audiocaps":
                ...
                inference_save_path = f"/home/work/kby_hgh/audio_full_{dataset}_inference_0603_1e-6/step_{checkpoint_num}"

            if dataset == "vggsound_sparse":
                target_path = "/home/work/kby_hgh/vggsound_sparse_test_curated_final_0320/audio"
                inference_save_path = f"/home/work/kby_hgh/audio_full_{dataset}_inference_0603_1e-6/step_{checkpoint_num}"

            # inference_save_path = f"/home/work/kby_hgh/MMG_NAIVE_DISTILL_step_{checkpoint_num}_ac/audio"
            # inference_save_path = f"/home/work/kby_hgh/NEW_MMG_OURS_ac_step_{checkpoint_num}/audio"
            # inference_save_path = f"/home/work/kby_hgh/NEW_MMG_NAIVE_DISTILL_ac_step_{checkpoint_num}/audio"
            # inference_save_path = f"/home/work/kby_hgh/MMG_ONLY_RC_DISTILL_{dataset}_step_{checkpoint_num}/audio"
            # inference_save_path = f"/home/work/kby_hgh/MMG_FILTERED_ONLY_RC_DISTILL_{dataset}_step_{checkpoint_num}/audio"


            # inference_save_path = f"/home/work/kby_hgh/FINAL_ALL_MMG_OURS_step_{checkpoint_num}_ac/audio"
            # inference_save_path = f"/home/work/kby_hgh/FINAL_FILTERED_MMG_OURS_step_{checkpoint_num}_ac/audio"
            # inference_save_path = f"/home/work/kby_hgh/MMG_FINAL_NAIVE_DISTILL_step_{checkpoint_num}_ac/audio"
            # inference_save_path = f"/home/work/kby_hgh/MMG_FINAL_FILTERED_RC_DISTILL_ac_step_{checkpoint_num}/audio"

            # inference_save_path = f"/home/work/kby_hgh/MMG_FINAL_FILTERED_RC_DISTILL_LINEAR_T_ac_step_{checkpoint_num}/audio"
            # inference_save_path = f"/home/work/kby_hgh/MMG_FINAL_FILTERED_RC_DISTILL_LINEAR_T_1e5_ac_step_{checkpoint_num}/audio"


            results = evaluate_model(args, device, target_path, inference_save_path, modality)

            result_csv_path = f"0603_audio_teacher_{modality}_{dataset}_eval_results.csv"
