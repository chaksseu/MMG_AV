...
def evaluate_model(args, device, target_path, inference_save_path, csv_path, modality="all"):
    ...
    fvd, clip_avg, imagebind_score = {'final': 0.0}, 0.0, [0.0]
    ...
    return fvd['final'], clip_avg, imagebind_score[0]
...
def main():
    ...
    dataset = "openvid" # vggsound_sparse # audiocaps # openvid
    modality ="video"
    ...
    # model_name_list = ["/home/work/kby_hgh/0613_FILTERED_FULL_MMG_RC_LENEAR_T_1_1_1_2_step", "/home/work/kby_hgh/0613_FILTERED_FULL_MMG_RC_LENEAR_T_1_2_10_10_step", "/home/work/kby_hgh/0613_FILTERED_FULL_MMG_RC_LENEAR_T_1_2_50_100_step"]
    model_name_list = ["/home/work/kby_hgh/0613_FILTERED_FULL_MMG_RC_LENEAR_T_1_2_50_100_step"]
    # checkpoint_dir_list = ["2015", "4031", "6047", "8063", "10079", "12095", "14111", "16127"] # 6
    checkpoint_dir_list = ["16127", "20159", "24191","28223", "40319", "44351"] # 6


    model_name_list = [0]
    checkpoint_dir_list = [0]

    # model_name_list = ["/home/work/kby_hgh/0610_FILTERED_FULL_MMG_OURS_step"]

    # checkpoint_dir_list = ["2015", "4031", "6047", "8063", "10079", "12095", "14111"] # 4


    # checkpoint_dir_list = ["2015", "4031", "6047", "8063", "10079", "12095", "14111"] # 4
    # checkpoint_dir_list = ["16127", "18143", "20159", "22175", "24191", "26207", "28223", "30239"] # 5


    # checkpoint_dir_list = ["32255", "34271", "36287", "38303", "40319", "42335", "44351", "46367"] # 3
    # checkpoint_dir_list = ["48383", "50399", "52415", "54431", "56447", "58463", "60479"] # 
    for model_name in model_name_list:
        for checkpoint_num in checkpoint_dir_list:
            ...
            # OPENVID_target_path = "/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_1920_test_videos_42"
            ...
            target_path = "/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_1920_test_videos_42"
            ...
            inference_save_path = f"/home/work/kby_hgh/0603_video_teacher_FULL_openvid_inference/checkpoint-step-81920"
            ...
            result_csv_path = f"0617_{dataset}_eval_results.csv"
