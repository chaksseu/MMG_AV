...
def evaluate_model(args, device, target_path, inference_save_path, csv_path, modality="all"):
    ...
    fad, clap_avg, fvd, clip_avg, imagebind_score = 0.0, 0.0, {'final': 0.0}, 0.0, [0.0]
    ...
    return fad, clap_avg, fvd['final'], clip_avg, imagebind_score[0]
...
def main():
    ...
    dataset = "vggsound_sparse" # vggsound_sparse # audiocaps # openvid
    modality ="all"
    ...
    checkpoint_dir_list = ["2015", "4031", "6047", "8063", "10079", "12095", "14111", "16127", "18143", "20159", "22175", "24191", "26207"]
    # checkpoint_dir_list = ["4031", "8063", "12095", "16127", "20159", "24191", "28223"]
    checkpoint_dir_list = ["14111", "16127", "18143", "20159", "22175", "24191", "26207"]
    ...
    for model_name in model_name_list:
        for checkpoint_num in checkpoint_dir_list:
            ...
            result_csv_path = f"0716_{model_name}_{dataset}_eval_results.csv"
