import os
os.environ["TRANSFORMERS_IMAGE_PROCESSING_USE_FAST"] = "true"
...
def main():
    ...
    # checkpoint_dir_list = ["4031", "8063", "12095", "16127", "20159", "24191", "28223"]
    # checkpoint_dir_list = ["14111", "16127", "18143", "20159", "22175", "24191", "26207", "28223"]
    checkpoint_dir_list = ["16127", "18143", "20159", "22175", "24191", "26207", "28223"]
    ...
    for model_name in model_name_list:
        for checkpoint_num in checkpoint_dir_list:
            ...
            target_path = "/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_1920_test_split_videos_0627"
            csv_path = "/home/work/kby_hgh/MMG_01/video_lora_training/0626_processed_Openvid_split_test_with_audio_caption_filtered_summerize.csv"
            
            # inference_save_path = f"{model_name}_{checkpoint_num}_{dataset}"
            
            # inference_save_path = f"/home/work/kby_hgh/0627_video_lora_openvid_inference_1e-5/step_253952"

            inference_save_path = f"/home/work/kby_hgh/0710_FILTERED_FULL_MMG_OURS_step_24191_openvid"
