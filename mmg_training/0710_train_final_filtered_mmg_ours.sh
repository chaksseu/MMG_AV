...
# ========================= 기본값 설정 =========================
DATE="0710_FILTERED_FULL_MMG_OURS"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0710_FILTERED_FULL_MMG_OURS_1e-4_ta_tv_weight_1_2/checkpoint-step-24191"
...
accelerate launch mmg_training/train_MMG_Model_0605_MMG_filtered_ours.py \
    --seed "$SEED" \
    --duration "$DURATION" \
