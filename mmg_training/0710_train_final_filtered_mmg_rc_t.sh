...
# ========================= 기본값 설정 =========================
DATE="0710_FILTERED_FULL_MMG_RC_LENEAR_T"
...
INFER_NAME="0710_FILTERED_FULL_MMG_RC_LENEAR_T_1_2_1_2"
...
RC_TA_AUDIO_LOSS_WEIGHT=1.0
RC_TV_VIDEO_LOSS_WEIGHT=2.0
...
echo "RC_TA_AUDIO_LOSS_WEIGHT: $RC_TA_AUDIO_LOSS_WEIGHT"
echo "RC_TV_VIDEO_LOSS_WEIGHT: $RC_TV_VIDEO_LOSS_WEIGHT" 
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0605_MMG_RC_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
    ...
    --rc_ta_audio_loss_weight "$RC_TA_AUDIO_LOSS_WEIGHT" \
    --rc_tv_video_loss_weight "$RC_TV_VIDEO_LOSS_WEIGHT"
