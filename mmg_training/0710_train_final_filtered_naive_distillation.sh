...
# ========================= 기본값 설정 =========================
DATE="0717_FILTERED_FULL_MMG_NAIVE_DISTILL"
...
EVAL_EVERY=63 # 317 # 633

TENSORBOARD_LOG_DIR="tensorboard/${DATE}_${LEARNING_RATE}_${LOG_NAME}"
INFER_NAME="0717_FILTERED_FULL_MMG_NAIVE_DISTILL"
...
TV_VIDEO_LOSS_WEIGHT=2.0

CSV_PATH="/home/work/kby_hgh/VGGSound_AV_CAM_SCORE/0511_cam_filtered_vggsound.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
TA_CSV_PATH="/home/work/kby_hgh/MMG_01/vggsound_processing/0403_combined_split_csvs/llm_combined_vgg_csv_0404.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
TV_CSV_PATH="/home/work/kby_hgh/MMG_01/vggsound_processing/0403_combined_split_csvs/llm_combined_vgg_csv_0404.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
VIDEO_LORA_CKPT_PATH="/home/work/kby_hgh/VIDEO_FULL_CHECKPOINT_0627/1e-5/checkpoint-step-253952/model.safetensors"
AUDIO_LORA_CKPT_PATH="/home/work/kby_hgh/AUDIO_FULL_CHECKPOINT_0709/1e-6/checkpoint-step-46720/model.safetensors"

INFERENCE_SAVE_PATH="/home/work/kby_hgh/"
CKPT_SAVE_PATH="/home/work/kby_hgh/MMG_CHECKPOINT"


CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0714_FILTERED_FULL_MMG_NAIVE_DISTILL_1e-4_ta_tv_weight_1_2_1_2/checkpoint-step-20159"
...
OPENVID_CSV_PATH="/home/work/kby_hgh/MMG_01/video_lora_training/0626_processed_Openvid_split_test_with_audio_caption_filtered_summerize.csv"
OPENVID_GT_TEST_PATH="/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_1920_test_split_videos_0627"

AC_CSV_PATH="/home/work/kby_hgh/MMG_AC_test_dataset/0627_one_cap_AC_split_test_with_video_caption.csv"
AC_GT_TEST_PATH="/home/work/kby_hgh/MMG_AC_test_dataset/0627_AC_test_split_wavs"
...
echo "OPENVID_CSV_PATH: $OPENVID_CSV_PATH"
echo "OPENVID_GT_TEST_PATH: $OPENVID_GT_TEST_PATH"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0605_MMG_naive_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
    ...
    --openvid_csv_path "$OPENVID_CSV_PATH" \
    --openvid_gt_test_path "$OPENVID_GT_TEST_PATH" \
