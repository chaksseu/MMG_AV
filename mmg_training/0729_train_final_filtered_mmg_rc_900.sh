...
# ========================= 기본값 설정 =========================
DATE="0729_FILTERED_FULL_MMG_RC_ge900"
...
INFER_NAME="0729_FILTERED_FULL_MMG_RC_1_2_1_2_ge900"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0729_MMG_RCD_ge900.py \
    --seed "$SEED" \
    --duration "$DURATION" \
