...
class AudioVideoDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        file_id = row["id"]
        audio_caption = row["caption"] # llm_audio_caption
        video_caption = row["new_caption"] # llm_video_caption        
        # audio_caption = row["combined_caption"] # llm_audio_caption
        # video_caption = row["combined_caption"] # llm_video_caption
        ...
        # 해상도가 target보다 작으면 패딩, 크면 랜덤 크롭 수행
        ...
        # print("after sliced_video")
        # print(sliced_video.shape)
        # # video_tensor
        ...
        return {
            ...
            "video_tensor": sliced_video,   # 전처리된 video tensor
