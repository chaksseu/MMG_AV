...
class AudioVideoDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        if tv_video_tensor.shape[1] != self.target_height or tv_video_tensor.shape[2] != self.target_width:
            print("tv_video_id:", tv_file_id)
            print("tv_caption:", tv_caption_text)
            print("tv_sliced_video.shape before padding:", tv_video_tensor.shape)

            _, height, width, _ = tv_video_tensor.shape
            ...
            tv_video_tensor = F.pad(tv_video_tensor, (0, 0, 0, pad_w, 0, pad_h), mode="constant", value=0)

            print("sliced_video.shape after padding:", tv_video_tensor.shape)
...
if __name__ == "__main__":
    ...
    ta_dir = "/workspace/data/MMG_TA_dataset_audiocaps_wavcaps_spec_0320"
    ta_csv_path = "/workspace/data/MMG_TA_dataset_audiocaps_wavcaps/MMG_TA_dataset_filtered_0321.csv"
    tv_dir = "/workspace/data/preprocessed_openvid_videos_train_0318"
    tv_csv_path = "/workspace/processed_OpenVid_0321.csv"  
    ...
    for batch in tqdm(dataloader, desc="Processing Batches", unit="batch"):
        ...
        # print("TAV_Captions:", batch["caption"])
