...
class AudioVideoDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        ta_audio_caption_text = ta_row["caption"]
        ta_video_caption_text = ta_row["new_caption"]

        tv_row = self.tv_df.iloc[tv_idx]
        tv_file_id = tv_row["id"]
        tv_audio_caption_text = tv_row["caption"]
        tv_video_caption_text = tv_row["compressed_video_caption"]
        ...
        return {
            ...
            "tv_video_caption": tv_video_caption_text,
            "tv_audio_caption": tv_audio_caption_text,
            "ta_spec": ta_spec,
            "ta_audio_caption": ta_audio_caption_text,
            "ta_video_caption": ta_video_caption_text,
        }
...
if __name__ == "__main__":
    ...
    ta_dir = "/home/work/kby_hgh/workspace/data/MMG_TA_dataset_audiocaps_wavcaps_spec_0320"
    ta_csv_path = "/home/work/kby_hgh/0505_RC_MMG_TA_dataset_filtered_with_video_caption.csv"
    tv_dir = "/home/work/kby_hgh/processed_OpenVid_1M_videos" 
    tv_csv_path = "/home/work/kby_hgh/splitted_openvid_csvs/0506_processed_Openvid_train_with_audio_caption_merged.csv"
    ...
    for batch in tqdm(dataloader, desc="Processing Batches", unit="batch"):
        ...
        print("TA_Audio_Captions:", batch["ta_audio_caption"])
        print("TA_Video_Captions:", batch["ta_video_caption"])
        print("TV_Audio_Captions:", batch["tv_audio_caption"])
        print("TV_Video_Captions:", batch["tv_video_caption"])
