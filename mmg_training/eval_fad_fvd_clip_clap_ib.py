...
def main():
    ...
    parser.add_argument("--inference_save_path", type=str, default="/home/work/kby_hgh/MMG_Inferencce_folder/tensorboard/0326_MMG_1e-5_HJ_8gpu_continue_step_69999_vggsound_sparse", help="모델 추론 결과 경로")
    ...
    parser.add_argument("--device", type=int, default=0, help="CUDA 디바이스 번호 (기본값: 0)")
