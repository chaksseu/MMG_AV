...
# ========================= 기본값 설정 =========================
DATE="0413_MMG_OURS"
LOG_NAME="8gpu_videocaption_continue2"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0413_MMG_OURS_1e-4_8gpu_videocaption_continue/checkpoint-step-20351"
...
PANDA_CSV_PATH="/home/work/kby_hgh/processed_csv_files/0409_onecap_processed_panda_70m_test.csv"
PANDA_GT_TEST_PATH="/home/work/kby_hgh/MMG_panda70m_test_dataset/filtered_40f_panda70m_32s_test"

CLOTHO_CSV_PATH="/home/work/kby_hgh/MMG_clotho_test_set/clotho_captions_evaluation.csv"
CLOTHO_GT_TEST_PATH="/home/work/kby_hgh/MMG_clotho_test_set/clotho_test_32s"
...
echo "PANDA CSV Path: $PANDA_CSV_PATH"
echo "PANDA GT Test Path: $PANDA_GT_TEST_PATH"
echo "CLOTHO CSV Path: $CLOTHO_CSV_PATH"
echo "CLOTHO GT Test Path: $CLOTHO_GT_TEST_PATH"
echo "======================================================================="

# ========================= 실행 명령어 =========================
# 아래에서 "train.py"는 실제 실행할 Python 스크립트 파일 이름입니다.
accelerate launch mmg_training/train_MMG_Model_0413_MMG_LoRA.py \
    --seed "$SEED" \
    --duration "$DURATION" \
    ...
    --panda_gt_test_path "$PANDA_GT_TEST_PATH" \
    --clotho_csv_path "$CLOTHO_CSV_PATH" \
    --clotho_gt_test_path "$CLOTHO_GT_TEST_PATH" \
