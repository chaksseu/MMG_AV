        ...
        with tqdm(dataloader, desc=f"Epoch {epoch+1}/{args.num_epochs}", unit="batch") as tepoch:
            for batch_idx, batch in enumerate(tepoch):
                ...
                with accelerator.accumulate(model):
                    ...
                    ta_distill_loss_audio = args.ta_audio_loss_weight * F.mse_loss(ta_audio_output, teacher_audio_output)
                    tv_distill_loss_video = args.tv_video_loss_weight * F.mse_loss(tv_video_output, teacher_video_output)
