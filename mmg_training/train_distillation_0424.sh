...
# ========================= 기본값 설정 =========================
DATE="0501_1138_MMG_NAIVE_DISTILL_continue"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0425_1611_MMG_NAIVE_DISTILL_1e-4_ta_tv_weight_1_1/checkpoint-step-71007"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0424_MMG_LoRA_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
