...
TA_CSV_PATH="/home/work/kby_hgh/again_mmg_TA_dataset_zip_0326/MMG_TA_dataset_filtered_0321.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
TV_CSV_PATH="/home/work/kby_hgh/0411_processed_Openvid_train.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0419_MMG_OURS_1e-4_8gpu_videocaption/checkpoint-step-20287"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0429_MMG_LoRA_distillation_RC.py \
    --seed "$SEED" \
    --duration "$DURATION" \
