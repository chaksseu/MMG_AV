...
# ========================= 기본값 설정 =========================
DATE="0524_FINAL_FILTERED_MMG_RC_LENEAR_T_1e5"
LOG_NAME="ta_tv_weight_1_2_1e5_"
...
EVAL_EVERY=63 # 633 # 317 # 158 # 80

TENSORBOARD_LOG_DIR="tensorboard/${DATE}_${LEARNING_RATE}_${LOG_NAME}"
INFER_NAME="FINAL_FILTERED_MMG_RC_LINEAR_T_1e5"
...
TV_CSV_PATH="/home/work/kby_hgh/splitted_openvid_csvs/0506_processed_Openvid_train_with_audio_caption_merged.csv" #"/workspace/processed_vggsound_sparse_0218/processed_vggsound_sparse_mmg.csv"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0524_FINAL_FILTERED_MMG_RC_LENEAR_T_1e5_1e-5_ta_tv_weight_1_2_1e5_/checkpoint-step-18143"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0524_MMG_LoRA_Only_RC_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
