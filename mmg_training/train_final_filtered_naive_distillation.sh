...
# ========================= 기본값 설정 =========================
DATE="0514_FINAL_FILTERED_NAIVE_DISTILLATION"
...
INFER_NAME="MMG_FINAL_NAIVE_DISTILL"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0514_FINAL_FILTERED_NAIVE_DISTILLATION_1e-4_ta_tv_weight_1_2/checkpoint-step-32255"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0503_MMG_LoRA_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
