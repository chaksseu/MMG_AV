...
# ========================= 기본값 설정 =========================
DATE="0513_MMG_ONLY_RC_DISTILL_VIDEO_FROZEN"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0509_MMG_LoRA_Only_RC_distillation_video_frozen.py \
    --seed "$SEED" \
    --duration "$DURATION" \
