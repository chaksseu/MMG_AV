...
# ========================= 기본값 설정 =========================
DATE="0511_MMG_ONLY_RC_DISTILL_FILTERED"
LOG_NAME="ta_tv_weight_1_1"
...
INFER_NAME="MMG_ONLY_RC_DISTILL_FILTERED"
...
CROSS_MODAL_CHECKPOINT_PATH="/home/work/kby_hgh/MMG_CHECKPOINT/checkpint_tensorboard/0511_MMG_ONLY_RC_DISTILL_FILTERED_1e-4_ta_tv_weight_1_1/checkpoint-step-22175"
...
# ========================= 실행 명령어 =========================
accelerate launch mmg_training/train_MMG_Model_0509_MMG_LoRA_Only_RC_distillation.py \
    --seed "$SEED" \
    --duration "$DURATION" \
