...
# 데이터를 저장할 기본 폴더 설정
OUTPUT_DIR = "latents_data_32s_40frames_vggsound_sparse_new_normalization"
...
def main():
    ...
    csv_file = "../_processed_data_32s_40frame/dataset_info.csv"
    video_folder = "../_processed_data_32s_40frame/video"
    audio_folder = "../_processed_data_32s_40frame/audio"
    ...
    for batch_idx, (videos, audios, texts) in enumerate(tqdm(dataloader, desc="Encoding batches")):
        ...
        with torch.no_grad():
            ...
            audio_latent = retrieve_latents(vae.encode(image), generator=generator)
