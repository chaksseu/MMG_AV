...
def parse_args():
    ...
    parser.add_argument("--spec_dir", type=str, default="/workspace/data/preprocessed_VGGSound_train_spec_0310", help="Spectrogram .pt 파일들이 있는 디렉토리 경로")
    parser.add_argument("--log_file", type=str, default="invalid_pt_files_0310.log", help="이상한 파일들을 기록할 로그 파일명")
    parser.add_argument("--num_workers", type=int, default=16, help="동시 실행할 워커 프로세스 수")
