...
def main():
    ...
    parser.add_argument("--spectrogram_dir", type=str, default="/workspace/data/preprocessed_VGGSound_train_spec_0310", help="미리 생성된 Mel Spectrogram(*.pt) 저장 폴더 경로") # /home/rtrt5060/preprocessed_spec, /home/jupyter/MMG_TA_dataset_audiocaps_wavcaps/preprocessed_spec
    ...
    parser.add_argument("--num_workers", type=int, default=16, help="병렬 처리에 사용할 CPU 코어 수")
