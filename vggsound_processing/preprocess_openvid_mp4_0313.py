...
# 설정 변수
SOURCE_DIR = '/workspace/openvid_1m_dataset/video'  # 원본 mp4 파일이 있는 폴더 경로
DEST_DIR = '/workspace/data/preprocessed_openvid_train_videos_0313'  # 전처리된 파일을 저장할 폴더 경로
MIN_DURATION = 3.5             # 최소 길이 (초)
