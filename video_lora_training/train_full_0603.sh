...
# ========================= 기본값 설정 =========================
VIDEO_CSV_PATH="/home/work/kby_hgh/MMG_01/video_lora_training/0602_processed_Openvid_train_with_audio_caption.csv"               # 실제 CSV 파일 경로
...
OPENVID_CSV_PATH="/home/work/kby_hgh/MMG_01/video_lora_training/0602_processed_Openvid_test_with_audio_caption.csv"                        # VGG eval 용 CSV 파일
OPENVID_INFERENCE_SAVE_PATH="/home/work/kby_hgh/video_lora_openvid_inference_${DATE}_${LR}"             # VGG eval 시 inference 저장 폴더
OPENVID_TARGET_FOLDER="/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_2000_test_videos_42"                   # VGG eval 시 GT 폴더 (비워두면 실행 안 됨)
