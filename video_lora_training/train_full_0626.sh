...
# ========================= 기본값 설정 =========================
VIDEO_CSV_PATH="/home/work/kby_hgh/MMG_01/vggsound_processing/0626_compressed_openvid_csvs/0626_processed_Openvid_train_with_audio_caption_summerize_merge.csv"               # 실제 CSV 파일 경로
VIDEO_DIR="/home/work/kby_hgh/processed_OpenVid_1M_videos"                   # 비디오 파일 폴더 경로

DATE="0627"

WANDB_PROJECT="video_teacher_full_training_0602"                 # WandB 프로젝트 이름
TRAIN_BATCH_SIZE=1 # 1
GRAD_ACC_STEPS=32 # 128 # 64
LR=1e-5
NUM_EPOCHS=16
...
RESUME_CHECKPOINT="/home/work/kby_hgh/VIDEO_FULL_CHECKPOINT_0627/1e-5/checkpoint-step-131072"

# ========================= 평가 관련 설정 =========================
EVAL_EVERY=8192             # 4096   # N step마다 평가
INFERENCE_BATCH_SIZE=2
INFERENCE_SAVE_PATH="/home/jupyter/video_full_inference_0213"
GUIDANCE_SCALE=12.0
...
OUTPUT_DIR="/home/work/kby_hgh/VIDEO_FULL_CHECKPOINT_${DATE}/${LR}" # checkpoint 저장 폴더 경로

# (필요 시) VGG 관련 설정
VGG_CSV_PATH="/home/work/kby_hgh/vggsound_sparse_test_curated_final_0320/vggsound_sparse_curated_292.csv"                        # VGG eval 용 CSV 파일
VGG_INFERENCE_SAVE_PATH="/home/work/kby_hgh/${DATE}_video_lora_vggsound_sparse_inference_${LR}"             # VGG eval 시 inference 저장 폴더
VGG_TARGET_FOLDER="/home/work/kby_hgh/vggsound_sparse_test_curated_final_0320/video"                   # VGG eval 시 GT 폴더 (비워두면 실행 안 됨)

OPENVID_CSV_PATH="/home/work/kby_hgh/MMG_01/video_lora_training/0626_processed_Openvid_split_test_with_audio_caption_filtered_summerize.csv"                        # VGG eval 용 CSV 파일
OPENVID_INFERENCE_SAVE_PATH="/home/work/kby_hgh/${DATE}_video_lora_openvid_inference_${LR}"             # VGG eval 시 inference 저장 폴더
OPENVID_TARGET_FOLDER="/home/work/kby_hgh/MMG_01/video_lora_training/processed_OpenVid_1920_test_split_videos_0627"                   # VGG eval 시 GT 폴더 (비워두면 실행 안 됨)
...
accelerate launch video_lora_training/train_0603_full.py \
    ...
    --openvid_inference_save_path "$OPENVID_INFERENCE_SAVE_PATH" \
    --openvid_target_folder "$OPENVID_TARGET_FOLDER" \
